                ...
                <div class="x_content">
                    ...
                    <div class="col-md-4" >
                        <div class="form-group col-md-12 <?php if( form_error('user_name') ) { echo 'has-error';} ?>">
                            ...
                            <input type="text" class="form-control" id="name" name="user_name"onkeyup="if (/[^|a-z0-9]+/g.test(this.value)) this.value = this.value.replace(/[^|a-z0-9 ]+/g,'')"  value = "<?php if(isset($user[0]['name'])){ echo $user[0]['name']; } else { echo set_value('user_name'); }  ?>" <?php //if(isset($user[0]['name'])){ echo "readonly"; }  ?> placeholder="Please Enter User Name">
                    ...
                    <div class="col-md-4">
                        <div class="form-group col-md-12  <?php if( form_error('booking_date') ) { echo 'has-error';} ?>">
                            ...
                            <input type="text" class="form-control" readonly="" id="booking_date" name="booking_date"  value = "<?php echo date('H') >= 14 ? date("d-m-Y", strtotime("+1 day")):date("d-m-Y", strtotime("+0 day")); ?>" style="background-color:#FFF;" >
