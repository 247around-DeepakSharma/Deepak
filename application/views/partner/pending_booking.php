                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" action="#" method="POST" target="_blank" id="escalate_form">
                        ...
                        <div class="modal-footer">
                            <center><input type= "submit"  onclick="return form_submit()" class="btn btn-primary" value ="Save" style="background-color:#2C9D9C; border-color:#2C9D9C;"></center>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
        ...
        $(document).ready(function(){
            ...
            "columnDefs": [
                {
                    "targets": [0,1,2,5,6,9,11,12,13,14,15,16,17], //first column / numbering column
