      ...
      <!-- end md-6 -->
       <div class="col-md-12">
         <div class="panel panel-default">
          ...
          <tr><td>Service Center Remarks: </td><td><?php if(!empty($query3)) {echo $query3[0]['service_center_remarks']; }?></td></tr>
          <tr><td>Admin Remarks: </td><td><?php if(!empty($query3)) { echo $query3[0]['admin_remarks']; } ?></td></tr>
         </table>
            </div>
            <div class="col-md-6">
            <table class="table table-bordered table-hover table-striped">
