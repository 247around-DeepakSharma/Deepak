                            ...
                            <tbody>
                                <?php foreach ($unit_details as $unit_detail) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if (!empty($unit_detail['purchase_month'])) {
                                                echo $unit_detail['purchase_month'] . "-" . $unit_detail['purchase_year'];
                                            } else {
                                                echo $unit_detail['purchase_year'];
                                            }
                                            ?></td>
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table  table-striped table-bordered">
                            <tr>
                                ...
                                <td><?php
                                    if (isset($service_center[0]['service_centre_name'])) {
                                        echo $service_center[0]['service_centre_name'];
                                    }
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <th>PoC Name: </th>
                                <td><?php
                                    if (isset($service_center[0]['primary_contact_name'])) {
                                        echo $service_center[0]['primary_contact_name'];
                                    }
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <th>PoC Number: </th>
                                <td><?php
                                    if (isset($service_center[0]['primary_contact_phone_1'])) {
                                        echo $service_center[0]['primary_contact_phone_1'];
                                    }
                                    ?>
                                </td>
                            </tr>
