                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <?php
                                                    $selected = (set_value('product_id') != '' ) ? set_value('product_id') : ($nrn_record['product_id'] != '' ? $nrn_record['product_id'] : '');
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Product Model no" type="text" class="form-control" name="product_model_no" id="product_model_no" required="" value="<?php echo (set_value('product_model_no') != '' ) ? set_value('product_model_no') : ($nrn_record['product_model_no'] != '' ? $nrn_record['product_model_no'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="product_capacity" class="col-md-4">Product capacity *</label>
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Product Capacity" type="text" class="form-control" name="product_capacity" id="product_capacity" required="" value="<?php echo (set_value('product_capacity') != '' ) ? set_value('product_capacity') : ($nrn_record['product_capacity'] != '' ? $nrn_record['product_capacity'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Repair Cost" type="text" class="form-control" name="repair_cost" id="repair_cost" required=""  value="<?php echo (set_value('repair_cost') != '' ) ? set_value('repair_cost') : ($nrn_record['repair_cost'] != '' ? $nrn_record['repair_cost'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter HDPL Direct Billing Point Invoice No." type="text" class="form-control" name="hdpl_invoice_no" id="hdpl_invoice_no" required=""  value="<?php echo (set_value('hdpl_invoice_no') != '' ) ? set_value('hdpl_invoice_no') : ($nrn_record['hdpl_invoice_no'] != '' ? $nrn_record['hdpl_invoice_no'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="hdpl_point" class="col-md-4">HDPL Direct Billing Point *</label>
                                                <div class="col-md-6">
                                                    <input placeholder="Enter HDPL Direct Billing Point" type="text" class="form-control" name="hdpl_point" id="hdpl_point" required=""  value="<?php echo (set_value('hdpl_point') != '' ) ? set_value('hdpl_point') : ($nrn_record['hdpl_point'] != '' ? $nrn_record['hdpl_point'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="vendor_warranty_expire_month" class="col-md-4">Vendor Warranty Exipre Month *</label>
                                                <div class="col-md-6">
                                                    <input placeholder="Select Vendor Warranty Exipre Month" readonly=""   onkeydown="return false;"  type="text" class="form-control" name="vendor_warranty_expire_month" id="vendor_warranty_expire_month" required="" autocomplete="off"  value="<?php echo (set_value('vendor_warranty_expire_month') != '' ) ? set_value('vendor_warranty_expire_month') : (($nrn_record['vendor_warranty_expire_month'] != '' && $nrn_record['vendor_warranty_expire_month'] != '0000-00-00') ? date('m/Y', strtotime($nrn_record['vendor_warranty_expire_month'])) : ''); ?>"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter ASF/Distributor Pin code" type="text" class="form-control" name="asf_distributor_pincode" id="asf_distributor_pincode" required=""  value="<?php echo (set_value('asf_distributor_pincode') != '' ) ? set_value('asf_distributor_pincode') : ($nrn_record['asf_distributor_pincode'] != '' ? $nrn_record['asf_distributor_pincode'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="control_no" class="col-md-4">Control No. *</label>
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Control No." type="text" class="form-control" name="control_no" id="control_no" required=""  value="<?php echo (set_value('control_no') != '' ) ? set_value('control_no') : ($nrn_record['control_no'] != '' ? $nrn_record['control_no'] : ''); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Replacement Model" type="text" class="form-control" name="replacement_model" id="replacement_model" required=""  value="<?php echo (set_value('replacement_model') != '' ) ? set_value('replacement_model') : ($nrn_record['replacement_model'] != '' ? $nrn_record['replacement_model'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="replacement_serial_no" class="col-md-4">Replacement Serial No. *</label>
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Replacement Serial No." type="text" class="form-control" name="replacement_serial_no" id="replacement_serial_no" required=""  value="<?php echo (set_value('replacement_serial_no') != '' ) ? set_value('replacement_serial_no') : ($nrn_record['replacement_serial_no'] != '' ? $nrn_record['replacement_serial_no'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Replacement AWB No." type="text" class="form-control" name="replacement_awb_no" id="replacement_awb_no" required="" value="<?php echo (set_value('replacement_awb_no') != '' ) ? set_value('replacement_awb_no') : ($nrn_record['replacement_awb_no'] != '' ? $nrn_record['replacement_awb_no'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="replacement_courier_name" class="col-md-4">Courier Name *</label>
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Courier Name" type="text" class="form-control" name="replacement_courier_name" id="replacement_courier_name" required="" value="<?php echo (set_value('replacement_courier_name') != '' ) ? set_value('replacement_courier_name') : ($nrn_record['replacement_courier_name'] != '' ? $nrn_record['replacement_courier_name'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="replacement_dispatch_date" class="col-md-4">Replacement Dispatch Date *</label>
                                                <div class="col-md-6">
                                                    <input placeholder="Select Replacement Dispatch Date" readonly=""   onkeydown="return false;"  type="text" class="form-control" name="replacement_dispatch_date" id="replacement_dispatch_date" required="" autocomplete="off"  value="<?php echo (set_value('replacement_dispatch_date') != '' ) ? set_value('replacement_dispatch_date') : (($nrn_record['replacement_dispatch_date'] != '' && $nrn_record['replacement_dispatch_date'] != '0000-00-00') ? date('d/m/Y', strtotime($nrn_record['replacement_dispatch_date'])) : ''); ?>"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Select Replacement Delivery Date" readonly=""   onkeydown="return false;"  type="text" class="form-control" name="replacement_delivery_date" id="replacement_delivery_date" required="" autocomplete="off"  value="<?php echo (set_value('replacement_delivery_date') != '' ) ? set_value('replacement_delivery_date') : (($nrn_record['replacement_delivery_date'] != '' && $nrn_record['replacement_delivery_date'] != '0000-00-00') ? date('d/m/Y', strtotime($nrn_record['replacement_delivery_date'])) : ''); ?>"/>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter ASM Name" type="text" class="form-control" name="category_done_by_asm" id="category_done_by_asm" required="" value="<?php echo (set_value('category_done_by_asm') != '' ) ? set_value('category_done_by_asm') : ($nrn_record['category_done_by_asm'] != '' ? $nrn_record['category_done_by_asm'] : ''); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Select Category after inspection Date" readonly=""   onkeydown="return false;"  type="text" class="form-control" name="category_after_inspection_date" id="category_after_inspection_date" required="" autocomplete="off"  value="<?php echo (set_value('category_after_inspection_date') != '' ) ? set_value('category_after_inspection_date') : (($nrn_record['category_after_inspection_date'] != '' && $nrn_record['category_after_inspection_date'] != '0000-00-00') ? date('d/m/Y', strtotime($nrn_record['category_after_inspection_date'])) : ''); ?>"/>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter ASM Name" type="text" class="form-control" name="pdi2_done_by_asm" id="pdi2_done_by_asm" required=""  value="<?php echo (set_value('pdi2_done_by_asm') != '' ) ? set_value('pdi2_done_by_asm') : ($nrn_record['pdi2_done_by_asm'] != '' ? $nrn_record['pdi2_done_by_asm'] : ''); ?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Select Date" readonly=""   onkeydown="return false;"  type="text" class="form-control" name="final_defective_status_date" id="final_defective_status_date" required="" autocomplete="off" value="<?php echo (set_value('final_defective_status_date') != '' ) ? set_value('final_defective_status_date') : (($nrn_record['final_defective_status_date'] != '' && $nrn_record['final_defective_status_date'] != '0000-00-00') ? date('d/m/Y', strtotime($nrn_record['final_defective_status_date'])) : ''); ?>"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Enter Name" type="text" class="form-control" name="vendor_name" id="vendor_name" required="" value="<?php echo (set_value('vendor_name') != '' ) ? set_value('vendor_name') : ($nrn_record['vendor_name'] != '' ? $nrn_record['vendor_name'] : ''); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input placeholder="Select Date" readonly=""   onkeydown="return false;"  type="text" class="form-control" name="vendor_reversal_date" id="vendor_reversal_date" required="" autocomplete="off"  value="<?php echo (set_value('vendor_reversal_date') != '' ) ? set_value('vendor_reversal_date') : (($nrn_record['vendor_reversal_date'] != '' && $nrn_record['vendor_reversal_date'] != '0000-00-00') ? date('d/m/Y', strtotime($nrn_record['vendor_reversal_date'])) : ''); ?>"/>
