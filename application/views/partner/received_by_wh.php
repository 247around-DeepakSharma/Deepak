<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                   <h2>Received Spares By Warehouse</h2>
                   <div class="pull-right"><a style="background: #2a3f54;border-color: #2a3f54;" href="<?php echo base_url(); ?>partner/download_received_spare_by_wh"  class="btn btn-sm btn-primary" id="download_excel" onmouseover="rowcount()">Download</a></div>
...
<script>
       $(document).ready(function () {
        ...
        approved_defective_parts_table = $('#approved_defective_parts_table').DataTable({
            ...
            "pageLength": 50,
            "ajax": {
                "url": "<?php echo base_url(); ?>employee/partner/received_defactive_parts_by_wh/",
                "type": "POST",
                "data": function(d){
            ...
            "columnDefs": [
                {
                   "targets": [0,2,7,8,9,10], //first column / numbering column
