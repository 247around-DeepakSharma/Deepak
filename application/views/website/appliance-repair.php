...
<html lang="en">
    <head>
        <title><?php echo $appliance_details['title'];?></title>
        <meta name="description" content="<?php echo $appliance_details['description'];?>">
        <meta name="keywords" content="<?php echo $appliance_details['keywords'];?>">
    ...
    <body>
        ...
        <div class="wrapper" id="atf-<?php echo str_replace(" ", "-", strtolower($appliance_details['service']));?>-services">
            <div class="container">
                <div class="header-top"></div>
                <div class="row formBox formSection">
                    <div class="head-small visible-xs-block"><?php echo $appliance_details['h1_text'];?></div>
                    <div class="head-call visible-xs-block">
                        <a href="tel:9555000247"><i class="fa fa-phone phone-style"></i>9555000247</a>
                    </div>
                    <div class="header-home hidden-xs col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                        <h1 class="light"><?php echo $appliance_details['main_headline'];?></h1>
                    </div>
                    <div class="col-md-12">
<!--                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="header-home col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                                            <h5 style="color:white">Use EXTRA50 coupon code on <a href="https://play.google.com/store/apps/details?id=com.handymanapp" target="_blank" style="color:white;">Android App</a> to avail Rs. 50 discount on every booking !!!</h5>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="wrapper particular-service">
            <div class="container-fluid">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-sm-3 col-md-12" >
                            <div class="homepage-section-header">
                                <h2><b><?php echo $appliance_details['h1_text'];?></b></h2>
                            </div>
                        </div>
                        
                        <div class="col-md-12">
                            <div class="hidden-xs col-sm-3 col-lg-3 col-md-3">
                                <?php $string = explode(".", $appliance_details['image'] ); ?>
                                <img class="service-image"
                                    src="website_assets/images/<?php echo  $string[0]."_177*133.".$string[1];?>"
                                    alt="<?php echo $appliance_details['alt_text'];?>">
                            </div>
                            <div class="col-xs-12 col-sm-9 col-lg-9 col-md-9 maintext">
                                <?php echo $appliance_details['content'];?>
                            </div>
                        </div>
                    </div>
                    
                    <div style="padding-top: 1cm;" class="mobile-screen hidden-xs fb-page  col-md-3 col-sm-10 col-xs-10" data-href="https://www.facebook.com/247around/" data-tabs="timeline" data-width="350" data-height="600" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                ...
                <div class="cta-how">
                    <div class="all-services how-cta"><span>Book Service</span></div>
                </div>
                
                <style type="text/css">
                    @media (max-width: 768px) {.blog_content_h2 h2{font-size: 18px;}
                </style>
        ...
        <script type="text/javascript">
            ...
            $(window).scroll(function() {
             ...
             $(".how-cta").click(function() {
                    $('html,body').animate({
                        scrollTop: $("#" + "atf-<?php echo str_replace(" ", "-", strtolower($appliance_details['service']));?>-services").offset().top},
                        1000);
                  });
            $(document).ready(function () {
