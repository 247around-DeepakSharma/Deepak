               ...
               <tbody> 	
               	...
               	<tr>
               		...
               		<td><?php echo $Getreview['name']; ?></td>
                        ...
                        <td><?php echo $Getreview['user_name']; ?></td>
                  ...
                  <td><?php if($Getreview['status'] == 1) { echo "Active";} else{ echo "Inactive";}?></td>
          
                <td >
                     <?php if($Getreview['status'] == 1) { ?>
                    <a class="btn btn-small btn-success btn-sm"  href="<?php echo base_url();?>review/toDoinactive/<?php echo $Getreview['id'];?>">Deactivate</a>
                <?php } else if($Getreview['status'] == 0){?>
               
                   <a class="btn btn-small btn-info btn-sm"  href="<?php echo base_url();?>review/toDoactive/<?php echo $Getreview['id'];?>">Activate</a>
                   </td>
                   <?php } ?>
                   <td>
                   <a class="btn btn-small btn-danger btn-sm"  href="<?php echo base_url();?>review/delete/<?php echo $Getreview['id'];?>">Delete</a>
                 </td>
                 <td>
   ...
   <div class="modal-dialog modal-lg" >
            <div class="modal-content" >
               ...
               <div class="modal-body">
                  <div class="col-md-12">
                     <form class="form-horizontal" action="<?php echo base_url()?>review/sending_mail" method="POST" enctype="multipart/form-data">
