<div id="page-wrapper">
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12">
            <h2 class="page-header">
               List of handyman Approve by employee <small></small>
            </h2>
            <ol class="breadcrumb">
               <li >
               ...
               <li>
                  <select id="dynamic_select">
                     <option value="<?php echo base_url().'employees/approvebyemployeehandyman/0'?>" <?php if($this->uri->segment(3) == 0){ echo 'selected';}?>>Today</option>
                     <option value="<?php echo base_url().'employees/approvebyemployeehandyman/2'?>" <?php if($this->uri->segment(3) == 2){ echo 'selected';}?>>Last3Days</option>
                     <option value="<?php echo base_url().'employees/approvebyemployeehandyman/14'?>" <?php if($this->uri->segment(3) == 14 ){ echo 'selected';}?>>Last2weeks</option>
                  </select>
               </li>
                <li >
      ...
      <p align="center" style="padding-top:20px;">
         <?php } else{ echo " handyman Not Approved";}?>
      </p>
      <!--   end of controllers -->
   </div>
</div>
