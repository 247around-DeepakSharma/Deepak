   ...
   <div class="container-fluid">
      ...
      <div class="pagination">
                <select id="dynamic_select">
                    <option value="<?php echo base_url().'handyman/viewhandyman'?>" <?php if($this->uri->segment(2) == 10){ echo 'selected';}?>>10</option>
                    <option value="<?php echo base_url().'handyman/viewhandyman/0/30'?>" <?php if($this->uri->segment(4) == 30){ echo 'selected';}?>>30</option>
                    <option value="<?php echo base_url().'handyman/viewhandyman/0/50'?>" <?php if($this->uri->segment(4) == 50){ echo 'selected';}?>>50</option>
                    <option value="<?php echo base_url().'handyman/viewhandyman/0/100'?>" <?php if($this->uri->segment(4) == 100){ echo 'selected';}?>>100</option>
                    <option value="<?php echo base_url().'handyman/Allview'?>" <?php if($this->uri->segment(2) == 'Allview'){ echo 'selected';}?>>All</option>
            ...
            <tr id="table_<?php echo $gethandyman['id']; ?>" class=" ">
               ...
               <td ><?php  if($gethandyman['image_processing'] == "1") {
                  ...
                  echo "NO";
                     ...
                     <td  class="verified_by_<?php echo $gethandyman['id']; ?>"><?php echo $gethandyman['verify_by'];?></td>
              ...
              <td >
                            ...
                            <?php ?>
                         <td id="statusbutton_<?php echo $gethandyman['id']; ?>"><button class="btn btn-small btn-info btn-sm" onclick="activate(<?php echo $gethandyman['id']?>)">Dectivate</button> </td>
                            <?php  }else if($gethandyman['action']==0){?>
      
                             <td id="statusbutton_<?php echo $gethandyman['id']; ?>"><button class="btn btn-small btn-primary btn-sm" onclick="deactivate(<?php echo $gethandyman['id']?>)">Activate</button></td>

                            <?php } }else  {?>
                            
                            <td id="statusbutton_<?php echo $gethandyman['id']; ?>"> <button class="btn btn-small btn-danger btn-sm" onclick="approvefilter(<?php echo $gethandyman['id']?>)">Approve</button></td>
                            <?php } }else  {?>
                          
                            <td id="statusbutton_<?php echo $gethandyman['id']; ?>"> <button class="btn btn-small btn-danger btn-sm" onclick="verify(<?php echo $gethandyman['id'];?>)">Verify</button></td>
                            <?php } ?>
      ...
      <p align="center" style="padding-top:20px;">
         <?php if(!empty($offset)){ redirect(base_url()."handyman/viewhandyman");} else { echo "Record Not Found";}?>
      </p>
      <?php }?>
   </div>
</div>
