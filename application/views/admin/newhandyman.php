   ...
   <div class="container-fluid">
      ...
      <div class="pagination">
                <select id="dynamic_select">
                    <option value="<?php echo base_url().'handyman/verifiedhandyman'?>" <?php if($this->uri->segment(2) == 10){ echo 'selected';}?>>10</option>
                    <option value="<?php echo base_url().'handyman/verifiedhandyman/0/30'?>" <?php if($this->uri->segment(4) == 30){ echo 'selected';}?>>30</option>
                    <option value="<?php echo base_url().'handyman/verifiedhandyman/0/50'?>" <?php if($this->uri->segment(4) == 50){ echo 'selected';}?>>50</option>
                    <option value="<?php echo base_url().'handyman/verifiedhandyman/0/100'?>" <?php if($this->uri->segment(4) == 100){ echo 'selected';}?>>100</option>
                    <option value="<?php echo base_url().'handyman/Allverified'?>" <?php if($this->uri->segment(2) == 'Allverified'){ echo 'selected';}?>>All</option>
