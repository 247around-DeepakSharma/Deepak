...
<div id="page-wrapper">
   <div class="container-fluid">
          ...
          <tbody>
           <tr>
               ...
               <td style="width:20%;padding:2px;vertical-align: middle;">
                  <p>
                     <a class="btn btn-small btn-success"  href="<?php echo base_url();?>popularsearch/editserachkeyword/<?php echo $search['id']?>">Edit</a>
                     <a class="btn btn-small btn-danger"  href="<?php echo base_url();?>popularsearch/DeleteSearchkeyword/<?php echo $search['id']; ?><?php echo "/".$offset?>">Delete</a>
                  </p>
               </td>
           </tr>
          </tbody>
      ...
      <p align="center" style="padding-top:20px;">
        <?php if(!empty($offset)){ redirect(base_url()."popularsearch/viewsearch");} else { echo "Record Not Found";}?>
      </p>
      <?php }?>
