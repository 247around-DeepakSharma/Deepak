         ...
         <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <a class="btn btn-small btn-success"  href="<?php echo base_url();?>employees/update/<?php echo $row['id'] ?>">Edit</a>
                  </td>
                 <td>
                     <a class="btn btn-small btn-danger"  href="<?php echo base_url();?>employees/delete/<?php echo $row['id'] ?>">Delete</a>
                  </td>
               </tr>
               <?php } ?>
            </tbody>
