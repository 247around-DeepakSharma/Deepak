                            ...
                            <tbody>
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td>
                                      ...
                                      <td>
                                        <?php if(!is_null($row['parts_shipped'])){ ?>  <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>service_center/acknowledge_delivered_spare_parts/<?php echo $row['booking_id']; ?>/<?php echo $this->session->userdata('service_center_id') ?>/<?php echo $this->session->userdata('service_center_agent_id') ?>/<?php echo $row['partner_id']; ?>" style="<?php if(is_null($row['parts_shipped'])){ echo 'pointer-events:none;';}?>">Received</a> <?php } else { echo "Part Shipment Pending";} ?>
                                        </td>
                                </tr>
                                <?php $sn_no1++; } ?>
                            </tbody>
