                           ...
                           <table id="today_datatable" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="margin-top:10px;">
                                ...
                                <tbody>
                                    ...
                                    <tr  style="text-align: center;"  >
                                        ...
                                        <td style="vertical-align: middle;"> <?php if(isset($row->age_of_booking)){ echo $row->age_of_booking." day";} ?></td>
                                        ...
                                        <td style="vertical-align: middle;">
                                            ...
                                            if ($row->nrn_approved==0) { 
                                                ...
                                                <?php } ?>
                                            <?php } else { ?>
                                            <a href="#" class='btn btn-sm btn-danger disabled' title='Cancel' <?php if(($row->service_center_current_status == SF_BOOKING_INPROCESS_STATUS && !empty($row->service_center_closed_date)) || ($row->service_center_current_status == _247AROUND_COMPLETED)) { echo 'disabled'; } ?>><i class='fa fa-times' aria-hidden='true'></i></a>
                                            <?php } ?>
                                        </td>                                        
                                    ...
                                    <tr  style="text-align: center;"  >
                                        ...
                                        <td style="vertical-align: middle;">
                                            ...
                                            <?php echo $row->booking_id; ?>
                                                ...
                                                <a href="javascript:void(0)" data-popover="true" style="width:10px;border:0px; white-space:nowrap; overflow:hidden;text-overflow:ellipsis;max-width: 125px;" data-html="true" data-content="<?php if(isset($row->part_cancel_reason)){ echo implode('<br>',explode(',',$row->part_cancel_reason));}?>" > <img class="<?php echo 'spare_rescheduled'.$key; ?>" id="<?php echo 'spare_rescheduled'.$key; ?>" src="<?php echo base_url(); ?>images/loader.gif"  style="width:84%"/></a>
