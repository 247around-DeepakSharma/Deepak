                            ...
                            <table id="datatable1" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Customer Name</th>
                                        <th>Phone No</th>
                                        <th>Age Of Estimate Given</th>
                                        <th>Customer Price</th>
                                        <th>Approve By Customer</th>
                                        <th>Reject By Customer</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
$(document).ready(function () {
        ...
        <?php $data = array('assigned_vendor_id' => $service_center_id, 'status' => SPARE_OOW_EST_GIVEN);
        ?>
         <?php $column = array(NULL,NUll,NULL,NULL,"age_of_est_given", NULL, NULL);?>
         var column_order = <?php echo json_encode($column);?>;
         var obj = '<?php echo json_encode($data); ?>';
         var select = '<?php echo "users.name, booking_primary_contact_no,booking_alternate_contact_no, "
         . "spare_parts_details.id, booking_details.booking_id, spare_parts_details.estimate_sell_cost, booking_details.amount_due, booking_details.state"; ?>';
         oow_spare = $('#datatable1').DataTable({
            ...
            "ajax": {
              ...
              data : {requestType:'<?php echo SPARE_OOW_EST_REQUESTED;?>', 'crmType': 'Vendor',
            ...
            "columnDefs": [
                {
                    "targets": [0,1,2,3,,5,6,7], //first column / numbering column
    ...
    function spare_estimate_cost(spare_id, booking_id){
    swal({
                title: "Are You Sure?",
                text: "Charges Approved By Customer",
                type: "warning",
            ...
            url: "<?php echo base_url() ?>employee/service_centers/approve_oow/"+spare_id+"/"+booking_id,
