	...
	<div class="panel panel-info" style="margin-top:20px;">
		...
		<form name="myForm" class="form-horizontal" id ="booking_form" action="<?php echo base_url() ?>employee/service_centers/process_complete_booking/<?php echo $booking_id; ?>"  method="POST" enctype="multipart/form-data">
			...
			<div class="col-md-12">
				...
				<div class="col-md-8" >
				    <textarea class="form-control"  rows="5" name="closing_remarks" readonly><?php
				...
				<div class="col-md-8" >
				    <textarea class="form-control"  rows="5" name="closing_remarks"><?php
					if (isset($charges[0]['service_center_remarks'])) {
					    echo str_replace("<br/>", "&#13;&#10;", $charges[0]['service_center_remarks']);
					}
					?></textarea>
				</div>
			    </div>
