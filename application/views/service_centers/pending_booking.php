...
<!--                    <div class="x_title">
            ...
            <div class="col-md-10 col-md-offset-2">
                <div style="margin-top:10px; display: flex;font-size: 25px;">
                    ...
                    <b><span <?php if ($rating > '3.5') {
                echo "class='text-success'";
            } else {
                echo "class='text-danger'";
            } ?>><?php echo $rating; ?> /5</span></b> &nbsp;
...
<?php } ?>
            ...
            <div class="col-md-10">
                <ul class="nav nav-tabs" role="tablist" >
                    <li role="presentation" class="active"><a href="#today_booking" aria-controls="today_booking" role="tab" data-toggle="tab"><?php if ($booking_id == '') { ?>Today Bookings<?php } else {
    echo "Searched Booking";
} ?></a></li>
                    <?php if ($this->session->userdata('is_update') == 1) { ?>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (obj[0].is_micro_wh == 1) {   //SPARE_DELIVERED_TO_SF
                        ...
                        $("#auot_delivered_"+ key).attr('data-courier-auto-delivered', response);
                        document.getElementById("spare_delivered_" + block + key).src = "<?php echo base_url(); ?>images/spare_parts_delivered_auto.png";
                        
                    } else if ((obj[0].status == '<?php echo SPARE_DELIVERED_TO_SF; ?>') && obj[0].auto_acknowledeged == 2){ 
                        document.getElementById("spare_delivered_" + block + key).src = "<?php echo base_url(); ?>images/spare_parts_delivered_api.png";
