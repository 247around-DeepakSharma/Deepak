                    ...
                    <tbody>
                        ...
                        <tr <?php echo $style ?>>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url() ?>employee/service_centers/get_update_shipment_form/<?php echo $value['order_id'] ?>" class="btn btn-sm btn-primary" title="Update Shipment" style="margin-bottom: 3px;" <?php if ($value['active'] == 0 || $is_shipped == 1 && $is_received == 1 || $is_shipped == 1 && $is_received == 0) {
                                    echo 'disabled=TRUE';
                                ...
                                <!--                                <a href="<?php base_url() ?>get_update_receiving_form/<?php echo $value['order_id'] ?>" class="btn btn-sm btn-primary" style="margin-bottom: 3px;" title="Update Receiving" <?php if ($value['is_shipped'] != 1 || $value['active'] == 0) {
                                    ...
                                    <a href="<?php echo base_url() ?>uncancel_brackets_request/<?php echo $value['order_id'] ?>" class="btn btn-sm btn-primary" style="margin-bottom: 3px;" title="Un-Cancel Request" <?php if ($value['active'] == 1) {
                                        echo 'disabled=TRUE';
