                    ...
                    <tbody>
                        ...
                        <tr <?php echo $style ?>>
                            ...
                            <td>
                                ...
                                <a href="<?php base_url() ?>get_update_shipment_form/<?php echo $value['order_id'] ?>" class="btn btn-sm btn-primary" title="Update Shipment" style="margin-bottom: 3px;" <?php if ($value['active'] == 0 || $is_shipped == 1 && $is_received == 1 || $is_shipped == 1 && $is_received == 0) {
                                    echo 'disabled=TRUE';
