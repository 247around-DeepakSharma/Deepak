<div id="page-wrapper" >
    <div style="margin-top:20px;">
        <div class="heading"><h2><?php if(isset($shipped_flag)){echo '<b>Update Shipment</b>';}elseif(isset($receiving_flag)){echo "<b>Update Delivery</b>";}elseif(isset($requested_flag)){echo '<b>Update/Cancel Order</b>';}?> </h2></div>
        <div>
            <?php if(isset($shipped_flag)){
                $form_submit_form = 'process_vender_update_shipment_form';
            }
            if(isset($receiving_flag)){
                $form_submit_form = 'process_vender_update_receiving_form';
            }
            if(isset($requested_flag)){
                $form_submit_form = 'process_vender_update_requested_form';
            }
            ?>
            ...
            <form name="myForm" class="form-horizontal" action='<?php echo base_url() ?>employee/service_centers/<?php echo $form_submit_form?>' method="POST" enctype="multipart/form-data">
...
//        }
        ...
        $('#total_received').val(_26_32_shipped + _36_42_received);
    }
