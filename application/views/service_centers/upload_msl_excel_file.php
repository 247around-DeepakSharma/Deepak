...
<!--            <a href="<?php //echo base_url(); ?>BookingSummary/download_latest_file/appliance" class="col-md-2"><button class="btn btn-success btn-sm">Download Latest File</button></a>-->
            <div class="col-md-12" style="margin-top:20px;">
                ...
                <table id="file_history" class="table table-striped table-bordered table-hover" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>S.No.</th>
                            <th>Download</th>
   ...
   function get_247around_wh_gst_number(partner_id){
    ...
    function upload_file_history(){ 
        table1 = $('#file_history').DataTable({
            ...
            ajax: {
                url: "<?php echo base_url(); ?>employee/service_centers/get_uploda_file_history",
                type: "POST",
                data: function(d){
                    d.file_type = '<?php echo 'Upload msl excel file by warehouse'; ?>';
