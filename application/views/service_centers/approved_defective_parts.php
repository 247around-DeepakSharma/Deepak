      ...
      <div class="col-md-12">
         ...
         <div class="panel panel-default">
            <div class="panel-heading">
                <h1 class="panel-title" ><i class="fa fa-money fa-fw"></i> Defective Parts Received By Partner <a class="btn btn-primary btn-sm" href="<?php echo base_url().'service_center/download_approved_defective_parts_booking/'.$offset; ?>" id="download" style="float:right;font-size:12px;color:white;margin-top:-6px;">Download List</a></h1>
            </div>
