...
<!--                           <b><?php if(isset($data[0]['name'])){echo ucfirst($data[0]['name']);} else { echo "Booking Not Found";} ?></b>-->
            ...
            <table class="table table-striped table-bordered table-hover">
               ...
               <tr>
                  ...
                  <td>
                     <a href="<?php echo base_url(); ?>service_center/booking_details/<?php echo base64_encode($row['booking_id']) ?>"
                        target='_blank'title='view' class='btn btn-sm btn-primary' <?php if(is_null($row['assigned_engineer_id'])){ echo "disabled"; }?>><i class='fa fa-eye' aria-hidden='true'></i></a>
                  </td>
