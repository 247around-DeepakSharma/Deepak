                ...
                <section>
                    ...
                    <div class="col-md-6">
                        ...
                        <table class='table table-condensed table-bordered'>
                            <thead>
                                <?php foreach ($services as $key => $value) { if ($key % 5 == 0) {echo "<tr>";} ?>
                                <td>
                                    <?php echo $value->services; ?>
                                </td>
                                <?php if (($key + 1) % 5 == 0) { echo "</tr>";}} ?>
                            </thead>
                        </table>
                    </div>
                </section>
...
<script>
    ...
    function submitForm() {
        ...
        if($('#partner_id').val()){
            ...
            fd.append('file_type','<?PHP echo PARTNER_APPLIANCE_MODEL_FILe ;?>');
            fd.append('redirect_url','employee/inventory/upload_appliance_model_details');
            $.ajax({
    ...
    function show_upload_file_history(){
        table = $('#datatable1').DataTable({
            ...
            ajax: {
                ...
                type: "POST",
                data: function(d){
                    d.file_type = '<?PHP echo PARTNER_APPLIANCE_MODEL_FILe ;?>';
                }
            },
            columnDefs: [
                {
