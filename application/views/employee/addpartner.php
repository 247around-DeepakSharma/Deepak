                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input  type="number" class="form-control" value = "<?php if(isset($query)){ echo $query[0]['upcountry_rate'];} ?>" name="upcountry_rate" id="upcountry_rate" placeholder="Enter KM's">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-8">
                                        <input  type="text" class="form-control"  name="upcountry_min_distance_threshold" value = "<?php if(isset($query)){ echo $query[0]['upcountry_min_distance_threshold'];} ?>">
                                                                            </div>
                                </div>
                                <div class="form-group ">
                                    <label for="upcountry_max_distance_threshold" class="col-md-4">Max Distance</label>
                                    <div class="col-md-8">
                                        <input  type="text" class="form-control"  name="upcountry_max_distance_threshold" value = "<?php if(isset($query)){ echo $query[0]['upcountry_max_distance_threshold'];} ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1">
                                        <input type="checkbox" name="upcountry_approval" id="upcountry_approval" style="zoom:1.5" 
                                            <?php if(isset($query)){ if($query[0]['upcountry_approval'] ==1){ echo "checked";}} ?> />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input  type="number" class="form-control" value = "<?php if(isset($query)){ echo $query[0]['upcountry_rate1'];} ?>" name="upcountry_rate1" id="upcountry_rate1"    placeholder="Enter KM's">
                                    </div>
                                    <div class="col-md-4">
                                        <span><i>[Enter Rate per KM]</i></span>
                                    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-8">
                                        <input  type="text" class="form-control"  name="upcountry_mid_distance_threshold" value = "<?php if(isset($query)){ echo $query[0]['upcountry_mid_distance_threshold'];} ?>">
                                                                            </div>
                                </div>
                                <div class="form-group ">
                                    <label for="upcountry_approval_email" class="col-md-4">Upcountry Approval Email</label>
                                    <div class="col-md-8">
                                        <input  type="text" class="form-control"  name="upcountry_approval_email" value = "<?php if(isset($query)){ echo $query[0]['upcountry_approval_email'];} ?>">
                                                                            </div>
                                </div>
                            </div>
                        </div>
