        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;background-color: lightgrey;">
            ...
            <ul class="nav navbar-top-links navbar-left">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu ">
                        <li>
                            <a href="<?php echo base_url() ?>employee/booking/view_bookings_by_status/Pending"><i class="fa fa-fw fa-desktop"></i> <strong> View Pending Booking</strong></a>
                        </li>
                        <li class="divider"></li>
                        <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo base_url() ?>employee/booking/view_bookings_by_status/Completed"><i class="fa fa-fw fa-desktop"></i> <strong>View Completed Booking</strong></a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo base_url() ?>employee/booking/view_bookings_by_status/Cancelled"><i class="fa fa-fw fa-desktop"></i> <strong>View Cancelled Booking</strong></a>
                        </li>
                        <li class="divider"></li>
                        <li >
