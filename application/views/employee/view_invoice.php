                    ...
                    <div class="col-md-12" style="margin-top: 20px;">
                        <table class="table priceList table-striped table-bordered" style="">
                            ...
                            <tr>
                                ...
                                <td style="width: 290px;"><?php echo $invoice_details[0]['invoice_date']; ?></td>
                            </tr>
                            <tr>
                                <td style="width: 185px;"><b>Period</b></td>
                                <td style="width: 290px;"><?php echo $invoice_details[0]['from_date']." to ".$invoice_details[0]['to_date']; ?></td>
                                
                                <td style="width: 185px;"><b>Due Date</b></td>
                                <td style="width: 290px;"><?php echo $invoice_details[0]['due_date']; ?></td>
                            </tr>
                            <tr>
