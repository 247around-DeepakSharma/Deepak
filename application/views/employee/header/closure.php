        ...
        <nav class="navbar navbar-default navbar-custom" role="navigation" style="margin-bottom: 0;">
            ...
            <ul class="nav navbar-top-links navbar-left">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu ">
                        <li >
                            <a href="<?php echo base_url() ?>employee/partner/viewpartner"><i class="fa fa-fw fa-desktop"></i> <strong> View Partner List</strong></a>
                        </li>
                        <li class="divider"></li>
                        <li >
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo base_url() ?>employee/user/show_holiday_list"><i class="fa fa-fw fa-desktop "></i> <strong>Holiday List 2018</strong></a>
                        </li>
                    </ul>
                </li>
