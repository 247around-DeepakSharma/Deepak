...
<div id="page-wrapper" style="width:140%;">
    <div class="">
        <div class="row">
            <?php  if($this->uri->segment(3) == 'status_sorted_booking'){?>
            <div class="pagination">
                <select id="dynamic_select">
                    <option value="<?php echo base_url().'employee/booking/status_sorted_booking'?>" <?php if($this->uri->segment(4) == 50){ echo 'selected';}?>>50</option>
                    <option value="<?php echo base_url().'employee/booking/status_sorted_booking/0/100'?>" <?php if($this->uri->segment(5) == 100){ echo 'selected';}?>>100</option>
                    <option value="<?php echo base_url().'employee/booking/status_sorted_booking/0/200'?>" <?php if($this->uri->segment(5) == 200){ echo 'selected';}?>>200</option>
                    <option value="<?php echo base_url().'employee/booking/viewpendingbooking'?>" <?php if($this->uri->segment(3) == 'viewbooking'){ echo 'selected';}?>>All</option>
            ...
            <div style="width:100%;margin-left:10px;margine-right:5px;">
                <h1 align="left"><b>Sorted Bookings (By Status)</b></h1>
                <table >
                    ...
                    <th>Booking Date</th>
                    <th>
                    <a href="<?php echo base_url();?>employee/booking/shorted_booking">Status</a>
                    </th>
                    <th>View</th>
                    <th>Reschedule</th>
                    <th>Cancel</th>
