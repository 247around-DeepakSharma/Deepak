   ...
   <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
              ...
              <form class="form-horizontal" action="<?php echo base_url()?>employee/booking/process_convert_cancelled_booking_to_pending_form/<?php echo $booking_id ?>" method="POST" >
