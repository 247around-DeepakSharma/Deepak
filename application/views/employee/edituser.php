...
<?php echo form_error('name'); ?>
                    ...
                    <div class="form-group <?php if (form_error('user_email')) {
    echo 'has-error';
} ?>">
...
<?php echo form_error('user_email'); ?>
                    ...
                    <div class="form-group <?php if (form_error('phone_number')) {
    echo 'has-error';
} ?>">
                    ...
                    <div class="form-group <?php if (form_error('alternate_phone_number')) {
                                echo 'has-error';
                            } ?>">
...
<?php echo form_error('alternate_phone_number'); ?>
                    ...
                    <div class="form-group <?php if (form_error('home_address')) {
    echo 'has-error';
} ?>">
...
<?php foreach ($state as $value) { ?>
                                    <option value="<?php echo $value['state']; ?>" <?php if ($user[0]['state'] == $value['state']) {
        echo "selected";
...
<?php } ?>
                    ...
                    <div class="form-group <?php if (form_error('pincode')) {
                                    echo 'has-error';
                                } ?>">
        ...
        <!--                    <input type="text" class="form-control"  name="pincode" value = "<?php //echo $user[0]['pincode']; ?>" >-->
                            <select type="text"  class="form-control"  id="pincode" name="pincode" required>
                                <option selected="selected" disabled="disabled">Select Pincode</option>
                                <?php
                                $flag = 0;
                                foreach ($pincode as $key => $value) {
                                    ?>
                                    <option <?php if ($value['pincode'] == $user[0]['pincode']) {
                                        echo "Selected";
                                        $flag = 1;
                                    } ?>><?php echo $value['pincode']; ?></option>
                                <?php } ?>
                                <?php if ($flag == 0) { ?>
