                    ...
                    <div class="col-md-12" >
                        <div class="col-md-6 ">
                            <div class="form-group col-md-12  ">
                                ...
                                <input type="text" class="form-control" style="font-size: 13px;"  id="invoice_id" placeholder="Enter Invoice ID" name="invoice_id" value = "" >
                            </div>
                        </div>
                         <div class="col-md-6 ">
                            <div class="form-group col-md-12  ">
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group col-md-12  ">
                                ...
                                <input type="text" class="form-control" style="font-size: 13px;"  id="parts_count" placeholder="Enter Parts Quantity" name="parts_count" value = "" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group col-md-12  ">
                                ...
                                <input type="text" class="form-control" style="font-size: 13px;"  id="parts_cost" placeholder="Enter Parts Charge" name="parts_charge" value = "" >
                            </div>
                        </div>
                        <div class="col-md-6 ">
                            <div class="form-group col-md-12  ">
                                <label for="remarks">GST Rate *</label>
                                <input type="text" class="form-control" style="font-size: 13px;" id="gst_rate" placeholder="Enter GST Rate" name="gst_rate" value = "" >
                            </div>
                        </div>
                        <div class="col-md-6 ">
                            <div class="form-group col-md-12  ">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-group col-md-12  ">
                                ...
                                <input type="text" class="form-control" style="font-size: 13px;"  id="gst_rate" placeholder="Enter Remarks" name="remarks" value = "" >
                            </div>
                        </div>
                    </div>
                </form>
