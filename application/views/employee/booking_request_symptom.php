        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">
                    <b> Add New Booking Symptom</b>
                </h1>
                <form class="form-horizontal"  id="fileinfo" action="<?php echo base_url();?>employee/booking_request/process_add_new_booking_request_symptom" name="fileinfo"  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?php if( form_error('request_type') ) { echo 'has-error';} ?>">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" id="request_type" name="request_type[]" required="" multiple="">
