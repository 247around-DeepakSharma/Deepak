   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12">
            ...
            <form class="form-horizontal" action="<?php echo base_url()?>employee/service/updateService/<?php if(isset($data['id'])) { echo $data['id'] ;} ?>/<?php echo $off;?>/<?php echo $page; ?>" method="POST" enctype="multipart/form-data">
               <div class="form-group <?php if( form_error('services') ) { echo 'has-error';} ?>">
                  <label for="service" class="col-md-2">Services</label>
                  <div class="col-md-6">
                     <input type="text" class="form-control"  name="services" value = "<?php if (isset($data['services'])) {echo $data['services']; }?>" data-role="tagsinput"  >
               ...
               <div class="form-group <?php if( form_error('distance') ) { echo 'has-error';} ?>">
                  ...
                  <div class="col-md-6">
                     <input type="text" class="form-control"  name="distance" value = "<?php if (isset($data['distance'])) {echo $data['distance']; }?>" data-role="tagsinput"  >
               ...
               <div class="form-group <?php if( form_error('keywords') ) { echo 'has-error';} ?>">
                  ...
                  <div class="col-md-6">
                     <input type="text" class="form-control"  name="keywords" value = "<?php if (isset($data['keywords'])) {echo $data['keywords']; }?>" >
               ...
               <div class="form-group">
                  <div class="col-md-10">
                     <center><a href="<?php echo base_url()?>employee/service/viewservices/<?php echo $off;?>/<?php echo $page;?>" class="btn btn-success btn-lg" style="margin: 2%;
