                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
                               ...
                               <input type="text" class="form-control" placeholder="Enter User Name" id="name" name="user_name"onkeyup="if (/[^|a-zA-Z0-9]+/g.test(this.value)) this.value = this.value.replace(/[^|a-zA-Z0-9 ]+/g,'')"  value = "<?php if(!empty($user)){ echo $user[0]['name'];} ?>" <?php if(!empty($user)){ ?>readonly="readonly" <?php } ?>>
