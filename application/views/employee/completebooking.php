                                        ...
                                        <tbody>
                                            ...
                                            <tr style="background-color: white; ">
                                                <td>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12 ">
                                                            <input type="text" style="text-transform: uppercase;pointer-events: none;background: #eee;margin-bottom: 5px;" tabindex="-1" onblur="validateSerialNo()" class="form-control" id="serial_number" name="serial_number"  value="<?php if(!empty($booking_history['spare_parts'][0]['serial_number']) && $booking_history['spare_parts'][0]['status'] <> _247AROUND_CANCELLED){ echo $booking_history['spare_parts'][0]['serial_number'];} else {echo $price["serial_number"];}  ?>"  placeholder = "Enter Serial Number" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode > 47 && event.charCode < 58) || event.charCode == 8" />
                                                            <input type="hidden" class="form-control" id="serial_number_pic" name="serial_number_pic"  value="<?php if(!empty($booking_history['spare_parts'][0]['serial_number_pic']) && $booking_history['spare_parts'][0]['status'] <> _247AROUND_CANCELLED){ echo $booking_history['spare_parts'][0]['serial_number_pic'];} else {echo $price["serial_number_pic"];} ?>"  />
                                                            ...
                                                            <input type="file" style="margin: 10px 0px;display:none;"  id="upload_serial_number_pic"   class="form-control" name="upload_serial_number_pic" value="<?php if(!empty($booking_history['spare_parts'][0]['serial_number_pic']) && $booking_history['spare_parts'][0]['status'] <> _247AROUND_CANCELLED){ echo $booking_history['spare_parts'][0]['serial_number_pic'];} else {echo $price["serial_number_pic"];}  ?>"   />
                                                            <?php
                                                            ...
                                                            elseif(!empty($booking_history['spare_parts'][0]['serial_number_pic']) && $booking_history['spare_parts'][0]['status'] <> _247AROUND_CANCELLED) {
                                                                $price_unit=$price['unit_id'];
