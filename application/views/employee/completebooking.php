                                                ...
                                                <td>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12 ">
                                                            ...
                                                            <input type="hidden" id="<?php echo "sno_required" . $count ?>" class="form-control" name="<?php echo "is_sn_file[" . $price['unit_id'] . "]" ?>" <?php if($price['is_sn_correct'] == IS_SN_CORRECT){ echo 'value="1"';} else { echo 'value="0"'; }?>   />
