   	...
   	<div class="row">
         <div class="col-lg-12">
            <h2 class="page-header">
               List of handyman Approve by  You <small></small>
            </h2>
            <ol class="breadcrumb">
               <li >
               ...
               <option value="<?php echo base_url().'employee/employee/approvedhandymanlist/0'?>" <?php if($this->uri->segment(4) == 0){ echo 'selected';}?>>Today</option>
               <option value="<?php echo base_url().'employee/employee/approvedhandymanlist/2'?>" <?php if($this->uri->segment(4) == 2){ echo 'selected';}?>>Last3Days</option>
               <option value="<?php echo base_url().'employee/employee/approvedhandymanlist/14'?>" <?php if($this->uri->segment(4) == 14 ){ echo 'selected';}?>>Last2weeks</option>
            </select>
               </li>
                <li >
