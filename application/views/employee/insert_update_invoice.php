                                    ...
                                    <div class="col-md-6">
                                        <select name="type" class="form-control" id="type_code" required>
                                            ...
                                            <option value="DebitNote" <?php if (isset($invoice_details[0]['type'])) {
                                                if(($invoice_details[0]['type'] == "DebitNote") || ($invoice_details[0]['type'] == "Debit Note")){ echo "selected";}
                                                } ?>>DebitNote</option>
                                            <option value="CreditNote" <?php if (isset($invoice_details[0]['type'])) {
                                                if(($invoice_details[0]['type'] == "CreditNote") || ($invoice_details[0]['type'] == "Credit Note")){ echo "selected";}
                                                } ?>>CreditNote</option>
