...
<!--                                            <input type="hidden" id="create_date_0" name="invoice[0][create_date]" value="<?php //if(isset($value['create_date'])){ echo $value['create_date'];  } ?>" >
                                    ...
                                    <tr>
                                        <td colspan="11"></td>
                                        <td>(+) TCS Rate % </td>
                                        <td class="amount_1"><input id="tcs_rate" type="number" step="any" onblur="calculate_total()" value="<?php if(isset($invoice_details[0]['tcs_rate'])){ echo $invoice_details[0]['tcs_rate']; }?>" name="tcs_rate" class="form-control padding_space" ></td>
                                        <td class="amount_1"><input id="tcs_amount" type="number" step="any" value="<?php if(isset($invoice_details[0]['tcs_amount'])){ echo $invoice_details[0]['tcs_amount']; } ?>" name="tcs_amount" class="form-control padding_space taxable_value" ></td>
