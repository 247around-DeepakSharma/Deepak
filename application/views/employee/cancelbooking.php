              ...
              <form class="form-horizontal" name="myForm" action="<?php echo base_url()?>employee/booking/process_cancel_form/<?php echo $user_and_booking_details[0]['booking_id']; ?>/<?php echo $user_and_booking_details[0]['current_status']; ?>" method="POST" >
                ...
                <?php  //}?>
                 ...
                 <div class="col-md-6 col-md-offset-4">
                     ...
                     <a href="<?php if(isset($internal_status)){ echo base_url()."employee/booking/view_queries/FollowUp/p_all/0/All"; } else { echo base_url()."employee/booking/view_bookings_by_status/Pending";} ?>"><input type="Button" value="Back" class="btn btn-primary"></a>
