            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        <tr>
                            <td><?php echo $sno;
                                    if ($value['is_upcountry'] == 1) {
                            ?>.<i style="color:red; font-size:20px;" onclick="open_upcountry_model('<?php echo $value['assigned_vendor_id']; ?>', '<?php echo $value['booking_id']; ?>', '<?php echo $value['amount_due']; ?>', '<?php echo $value['flat_upcountry']; ?>')" class="fa fa-road" aria-hidden="true"></i><?php } ?></td>
                            <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <button type="submit" align="center" class="btn btn-success" id="cancel_reschedule" onclick="return cancel_reschedule_request()">Cancel Reschedule</button>
                </form>
            </div>
...
<script>
    ...
    function cancel_reschedule_request() {
        ...
        $('#loader_gif').show();
        $('#cancel_reschedule').prop("disabled", true);
        $.ajax({
            type: 'POST',
            url: url,
