      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <h1 class="page-header">
               <img src="https://d28hgh2xpunff2.cloudfront.net/vendor-320x252/<?php echo $data['profile_photo'] ; ?>" class="img-circle  "  style="width:80px; height:80px;">  <?php if (isset($data['name'])) {echo ucfirst($data['name']); }?> <!-- <small><a href="<?php echo base_url()?>employee/handyman/viewhandyman/<?php echo $off;?>" class="btn btn-success pull-right">Back</a></small> -->
            </h1>

            <ul class="nav nav-tabs" role="tablist">
               <li role="presentation" class=" col-md-3 <?php if(isset($_GET['tab']) && $_GET['tab'] == 'home') {echo "active" ;} else if($this->uri->segment(3) == 'updateHandyman') {echo 'active' ;}   ?>"><a href="#home" aria-controls="home" role="tab" data-toggle="tab" style="text-align:center">Home</a></li>
            ...
            <div class="tab-content">
               <div role="tabpanel" class="tab-pane <?php if(isset($_GET['tab']) && $_GET['tab'] == 'home') {echo 'in active' ;} else if($this->uri->segment(3) == 'updateHandyman') {echo 'in active' ;} ?>" id="home">
                  <div class="container" style="margin-top:5%;">
                     <div class="row">
                        <div class="col-lg-12">
                           <form class="form-horizontal" action="<?php echo base_url()?>employee/handyman/updateHandyman/<?php echo $handyman ?>/<?php echo $off;?>" method="POST" >
                               ...
                               <div class="form-group <?php if( form_error('experience') ) { echo 'has-error';} ?>">
                                 ...
                                 <div class="col-md-6">
                                   ...
                                   <select  name="experience" class="js-example-basic-multiple form-control">
                                    <option disabled>Select Experience Range<option>
               ...
               <div role="tabpanel" class="tab-pane <?php if(isset($_GET['tab']) && $_GET['tab'] == 'upload') {echo 'in active' ;}?>" id="upload" style="margin-top:5%">
                  <form class="form-horizontal" action="<?php echo base_url()?>employee/handyman/uploadphoto/<?php if(isset($handyman_id)) {echo $handyman ; }?>/<?php echo $off;?>" method ="POST" enctype="multipart/form-data">
               ...
               <div role="tabpanel" class="tab-pane <?php if(isset($_GET['tab']) && $_GET['tab'] == 'identity') {echo 'in active' ;}?>" id="identity" style="margin-top:5%">
                  <form class="form-horizontal" action="<?php echo base_url()?>employee/handyman/identity/<?php if(isset($handyman_id)) {echo $handyman ; } ?>/<?php echo $off;?>"  method ="POST" enctype="multipart/form-data">
                     <fieldset <?php if(!isset($handyman_id)) { echo 'disabled';}?>>
                        <div class="form-group <?php if( form_error('id_proof_name') ) { echo 'has-error';} ?>" >
                           ...
                           <div class="col-md-6">
                              <select class="js-example-basic-multiple form-control" name ="id_proof_name" required>
                                 <option disabled>------Select Any Identity -----<option>
               ...
               <div role="tabpanel" class="tab-pane <?php if(isset($_GET['tab']) && $_GET['tab'] == 'agent') {echo 'in active' ;}?>" id="agent" style="margin-top:5%">
                  <form class="form-horizontal" action="<?php echo base_url()?>employee/handyman/agent/<?php if(isset($handyman_id)) {echo $handyman ; } ?>/<?php echo $off;?>" method="POST">
                     <fieldset <?php if(!isset($handyman_id)) { echo 'disabled';}?>>
                        <div class="form-group ">
                      ...
                      <?php $price =  json_decode($data['pricing'],true);?>
                        <form class="form-horizontal"  action="<?php echo base_url()?>employee/handyman/pricing/<?php if(isset($handyman_id)) {echo $handyman ; } ?>/<?php echo $off;?>" method="POST" id="myform" >
                          <?php if(!empty($price['service'])){for($i=0;$i<count($price['service']);$i++){?>
                            <div class="repeatingSection form-group <?php if( form_error('service[]') ) { echo 'has-error';} ?> <?php if( form_error('price[]') ) { echo 'has-error';} ?> ">
                                <label for="service" class="col-md-2">Service</label>
                                <div class="col-md-3">
                                    <input type="text" class="form-control" id="service" name="service[]" value="<?php echo $price['service'][$i] ?>"  required>
                                    <?php echo form_error('service[]'); ?>
                                </div>
                                <div class="col-md-3">
                                    <input type="text" class="form-control" id="price" name="price[]" value="<?php echo $price['price'][$i] ?>" placeholder="Price"  required>
                   ...
                   <div role="tabpanel" class="tab-pane <?php if(isset($_GET['tab']) && $_GET['tab'] == 'certification') {echo 'in active' ;}?>" id="certification" style="margin-top:5%">
                       <form class="form_horizontal" action = "<?php echo base_url()?>employee/handyman/addcertification/<?php if(isset($handyman_id)) {echo $handyman ; } ?>/<?php echo $off;?>" method="POST">
                           <fieldset <?php if(!isset($handyman_id)) { echo 'disabled';}?>>
                                 <div class="form-group">
