...
<div id="page-wrapper">
    <div class="row">
        <div class="title">
            <div class="row">
                <div class="col-md-6">
                    <h3>MSL Security Amount List</h3>
                </div>
            </div>
        </div>
        <hr>
            ...
            <div class="row">
                <div class="form-inline">
                    <div class="form-group col-md-3">
                        <label for="service_centre_id">Service Center</label>
                        <select class="form-control" id="service_centre_id">
                            <option value="0" selected>All</option>
                        </select>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="daterange">Invoice Date</label>
                        <input type="text" class="form-control" id="daterange" name="daterange">
                    </div>
                    <button class="btn btn-success col-md-2" id="get_invoice_data" style="margin-top:20px;">Submit</button>
                </div>
            </div>
        <hr>
            ...
            <table class="table table-bordered table-hover table-striped" id="invoice_list">
                <thead>
                    <tr>
                        ...
                        <th>Total Invoice Amount (with GST)</th>
...
<script>
    ...
    function get_invoice_list(){
        invoice_table = $('#invoice_list').DataTable({
            ...
            buttons: [
                {
                    ...
                    pageSize: 'LEGAL',
                    title: 'MSL_Security_Amount_Invoice_List',
                    exportOptions: {
                       columns: [1,2,3,4,5],
                        modifier : {
                             // DataTables core
            ...
            "ajax": {
                "url": "<?php echo base_url(); ?>employee/invoice/get_msl_security_amount_data",
                "type": "POST",
                data: function(d){
