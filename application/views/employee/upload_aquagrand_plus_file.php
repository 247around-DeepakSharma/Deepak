        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">
                    <b> Upload Aquagrand Plus File</b>
                </h1>
...
<script>
    function submitForm() {
        ...
        fd.append('file_type','<?php echo _247AROUND_AQUAGRAND_PLUS_DELIVERED; ?>');
        fd.append('partner_id','<?php echo AQUAGRAND_PLUS_ID; ?>');
        fd.append('partner_source','Aquagrand-plus-delivered-excel');
        fd.append('redirect_to','upload_aquagrand_plus_file');
        $.ajax({
    ...
    $(document).ready(function () {
        table = $('#datatable1').DataTable({
            ...
            ajax: {
                ...
                type: "POST",
                data: {file_type: '<?php echo _247AROUND_AQUAGRAND_PLUS_DELIVERED; ?>'}
            },
            columnDefs: [
                {
                    "targets": [0, 1, 2, 3,4],
