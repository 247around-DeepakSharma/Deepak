      ...
      <div class="row">
         <div class="col-lg-12">
          ...
          <h2 class="page-header">
            ...
            <form class="form-horizontal" action="<?php echo base_url()?>employee/excel/upload" method="POST"  enctype="multipart/form-data">
        ...
        <div class="container" style="margin-top: 54px;">
         ...
         <thead>
          ...
          <tbody>
            ...
            <tr >
                <td><?php echo $i;?></td>
               <td><img src="https://s3.amazonaws.com/vendor-original/<?php echo $gethandyman[0]['profile_photo'] ; ?>" class="img-circle  "  style="width:60px; height:60px;"></td>
