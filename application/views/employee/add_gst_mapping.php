                        ...
                        <form id="new_credit_note" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url(); ?>employee/spare_parts/process_add_gst_details_for_partner" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <label class="radio-inline">
                                  <input type="radio" name="entity_type" class="radiobutton" value="partner"  id="partner" >Partner
                                  </label>
                               ...
                               <div class="form-group" id="warehousepartner" >
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                      <select style="width: 100% !important;" name="partner" class="form-control" id="partners">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                      <select style="width: 100% !important;" name="state" class="form-control" id="states">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="gst_number" step=".02" required="required" class="form-control col-md-7 col-xs-12" name="gst_number">
