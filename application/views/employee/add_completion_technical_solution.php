        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">
                    <b> Add Completion Technical Solution</b>
                </h1>
                <form class="form-horizontal"  id="fileinfo" action="<?php echo base_url();?>employee/booking_request/process_add_new_completion_technical_solution" name="fileinfo"  method="POST" enctype="multipart/form-data">
