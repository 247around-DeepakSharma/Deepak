               ...
               <div role="tabpanel" class="tab-pane active">
			    ...
			    <form class="form-horizontal" action="<?php echo base_url() ?>employee/vendor/process_vendor_escalation_form" method="POST" >
                                <div class="form-group">
                                   ...
                                   <div class="col-md-6">
                                       <input type="text" class="form-control"  id="booking_id" name="booking_id"  value = "<?php echo $booking_id;?>" placeholder = "Booking Id"  readonly>
                                   </div>
                                </div>
                                <div class="form-group ">
                                   <label for="vendor_name" class="col-md-2">Vendor Name</label>
                                   <div class="col-md-6">
                                       <input type="text" class="form-control"  id="vendor_name" name="vendor_name"  value = "<?php echo  $vendor_details[0]['name']; ?>"  disabled>
