                                ...
                                <form id="spareForm_dc" method="post" class="form-horizontal" novalidate="novalidate">
                                    <div class="static-form-box">
                                        <div class="form-group">
                                            <label class="col-xs-4 col-sm-2 control-label">Partner *</label>
                                            <div class="col-xs-8 col-sm-4">
                                                <select class="form-control" name="partner_id" id="partner_id_dc" required=""></select>
                                                <label for="partner_id" class="error"></label>
                                            </div>
                                            <label class="col-xs-4 col-sm-2 control-label"><?php if(!$saas){ ?>247around<?php }?> Warehouses *</label>
                                            <div class="col-xs-8 col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-4">
                                                <!--                                                <input placeholder="Enter Courier Name" type="text" class="form-control" name="courier_name" id="courier_name" required=""/>-->
                                                <select class="form-control" id="courier_name" name="courier_name" id="courier_name_dc" required="">
                                                    <option selected="" disabled="" value="">Select Courier Name</option>
                                                    <?php foreach ($courier_details as $value1) { ?> 
                                                    <option value="<?php echo $value1['courier_code']; ?>"><?php echo $value1['courier_name']; ?></option>
                                                    <?php } ?>
                                    ...
                                    <div class="dynamic-form-box" id="appliance_details_id_dc">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-6 col-md-2">
                                                ...
                                                <label for="serviceId_dc_0" class="error"></label>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-2">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-1">
                                                ...
                                                <label for="quantity_dc_0" class="error"></label>
                                            </div>
                                            
                                            <div class="col-xs-12 col-sm-6 col-md-1">
                                                <input type="text" class="form-control allowNumericWithOutDecimal" name="part[0][hsn_code]" id="partHsnCode_dc_0" value=""/>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-1">
                                               <!-- <input type="number" class="form-control allowNumericWithOutDecimal" name="part[0][gst_rate]"  id="partGstRate_0" min="5" max="28" value="" />-->
                                        ...
                                        <div class="form-group hide" id="partTemplate_dc">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-1">
                                                <input type="text" class="form-control allowNumericWithOutDecimal" id="partHsnCode_dc" value="" />
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-1">
                                               <!-- <input type="number" class="form-control allowNumericWithOutDecimal" id="partGstRate" value="" min="5" max="28" /> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-5 col-md-4 col-md-offset-5">
                                                ...
                                                <input type="hidden" class="form-control" id="partner_name_dc"  name="partner_name" value=""/>
...
<script>
	...
	var partArr_dc = new Array();
    var BookingArr = new Array();
    $(document).ready(function () {
        
        partIndex = 0;
        $('#partner_id,#on_partner_id,#partner_id_dc').select2({
    ...
    //        });
       ...
       // get_vendor('','');        
        ...
        $("#partner_id_dc").on('change',function(){
            var partner_id = $("#partner_id_dc").val();              ;   
              get_vendor_dc('1',partner_id);
              get_partner_gst_number(partner_id);
              get_247around_wh_gst_number(partner_id);
        });
    ...
    function get_vendor_dc(is_wh,partner_id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>employee/vendor/get_service_center_with_micro_wh',
            data:{is_wh:is_wh,partner_id:partner_id},
    ...
    function get_partner_list(){
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#partner_id_dc").html(response);
                var option_length = $('#partner_id_dc').children('option').length;
                if(option_length == 2){
                 $("#partner_id_dc").change();   
                }
            }
        });
    }
    ...
    function get_appliance_dc(index){
        var partner_id = $('#partner_id_dc').val();
        if(partner_id){
            $.ajax({
                type: 'POST',
    ...
    function get_part_name(index){
        ...
        if($.inArray(part_number,partArr_dc[service_id]) > parseInt(-1)) {
           $('#partNumber_'+index).val('');
           alert("Please enter another part as this is already enter !");
           return false;
        }
        if( partArr_dc[service_id] === undefined ) {
            partArr_dc[service_id] = new Array();
        }
        if(part_number !='') {
            partArr_dc[service_id].push(part_number);
        }
...
//            }
    ...
    function onbooking_invoice_amount(){
        ...
        $("#spareForm_dc").on('submit', function(e) {
            ...
            if (isvalid) {
                ...
                var partner_name = $('#partner_id_dc option:selected').text();
                $('#partner_name_dc').val(partner_name);
    ...
    //                                }                                
                                if(obj.status){
                                    ...
                                    $('#select2-partner_id_dc-container').attr('title','Select Partner');
                                    ...
                                    $('.error_msg_div_dc').fadeTo(8000, 500).slideUp(500, function(){$(".error_msg_div").slideUp(1000);});
        ...
        $('#spareForm_dc').on('click', '.addButton', function () {
            ...
            $clone
                ...
                .find('[for="service_id_dc"]').attr('for','serviceId_dc_'+partIndex).end()
                ...
                .find('[for="part_number_dc"]').attr('for','partNumber_dc_'+partIndex).end()
                ...
                .find('[for="part_name_dc"]').attr('for','partName_dc_'+partIndex).end()
                ...
                .find('[for="quantity_dc"]').attr('for','quantity_dc_'+partIndex).end()
