        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">
                    <b> Add New Spare Symptom</b>
                </h1>
                <form class="form-horizontal"  id="fileinfo" action="<?php echo base_url();?>employee/booking_request/process_add_new_spare_symptom" name="fileinfo"  method="POST" enctype="multipart/form-data">
