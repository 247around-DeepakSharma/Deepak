...
<script src="https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/jquery.validate.min.js"></script>
    ...
    <div class="booking_history_div">   
        ...
        <table  class="table table-striped table-bordered">
            <tr>
                <th class="jumbotron" style="text-align: center">S.No.</th>
    ...
    <table  class="table table-striped table-bordered table-hover">
        <tr>
            <th class="jumbotron" style="text-align: center;width: 1%">S.No.</th>
...
<td><?php
      ...
      <?php } ?>
<!-- Start SMS Log history -->
<div class="sms_history_log_div">
    ...
    <div class="table-responsive">
        <table  class="table table-striped table-bordered table-hover">
            ...
            <?php } else{?>
                <tr>
                        <td colspan="4" style="text-align: center">No SMS History Found.</td>
                    </tr>
            <?php } ?>
...
<!-- End SMS Log history -->
<!-- Start Email log history details --> 
<div class="email_history_log_div">
    <hr>
    ...
    <table  class="table table-striped table-bordered table-hover">
        ...
        <?php }else{ ?>
                <tr>
                    <td colspan="7" style="text-align: center">No Email History Found.</td>
                </tr>
        <?php } ?>
    </table>
...
<!-- End Email log history details -->
    
<!-- Start Whatsapp log history details --> 

<div class="whatsapp_history_log_div">
    ...
    <div class="table-responsive">
     <table  class="table table-striped table-bordered table-hover">
         ...
         <?php if (!empty($whatsapp_logs) ) { ?>
             ...
             <?php } else {?>
            <tr>
                <td colspan="7" style="text-align: center">No Whatsapp Log History Found.</td>
            </tr>
         <?php } ?>
     </table>
 </div>
 </div> 
<!-- End Whatsapp log history details -->
<script>
