                ...
                <div class="col-md-3">
                   <div class="form-group">
                       ...
                       <label class="radio-inline col-md-6" style="font-weight:bold">
                           <input type="radio" name="part[<?php echo ($key +$count); ?>][shippingStatus]" required="" id="<?php echo "shippingStatus_".($key +$count);?>" value="1">Shipping
                          </label>
                    </div>
                    <div class="form-group">
                       
                        <label class="radio-inline col-md-6" style="font-weight:bold">
                            <input type="radio" name="part[<?php echo ($key +$count); ?>][shippingStatus]" required="" id="<?php echo "shippingStatus_".($key +$count);?>" value="0">Not Shipping
                          </label>
                    </div>
                    <div class="form-group">
                       
                         <label class="radio-inline col-md-6" style="font-weight:bold">
                             <input type="radio" name="part[<?php echo ($key +$count); ?>][shippingStatus]" required="" id="<?php echo "shippingStatus_".($key +$count);?>" value="-1">To be Shipped
                      </label>
                    </div>
