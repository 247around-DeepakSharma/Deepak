            ...
            <span id="errmsg1"></span>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="tds_amount" name="tds_amount" value="<?php if(isset($selected_tds)){ echo $selected_tds; }?>" <?php if(!empty($id)) {?>disabled <?php } ?>required>
                </div>
                <span id="errmsg4"></span>
              </div>
