<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="row">
                <h1 class="col-md-6 col-sm-12 col-xs-12"><b> Add New Solution </b></h1>
                <?php if($this->session->userdata('user_group') != 'closure'){?>
                    <div class="col-md-6 col-sm-12 col-xs-12" style="float:right;margin-top: 30px;margin-bottom: 10px;">
                        <a href="<?php echo base_url();?>employee/booking_request/solution_list"><input class="btn btn-primary pull-right" type="Button" value="View Solution"></a>
                    </div>
                <?php }?>
            </div>   
            <?php
            ...
            <hr>
            <div class="col-lg-12">
                <form class="form-horizontal"  id="fileinfo" action="<?php echo base_url();?>employee/booking_request/process_add_new_solution" name="fileinfo"  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="col-md-4 col-md-offset-2">
                            <input type="submit"  class="btn btn-success btn-md" id="submit_btn" value ="Add Solution" >
                        </div>
                    </div>
                </form>
            </div>
