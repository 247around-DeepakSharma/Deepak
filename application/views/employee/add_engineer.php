                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <div class="form-group <?php if( form_error('name') ) { echo 'has-error';} ?>">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" id="name" name="name" onkeyup="if (/[^|a-zA-Z0-9]+/g.test(this.value)) this.value = this.value.replace(/[^|a-zA-Z0-9 ]+/g,'')"  value = "<?php echo isset($data[0]['name'])?$data[0]['name']:set_value('name');  ?>" placeholder="Enter Engineer Name" required>
                                    </div>
