                ...
                <div role="tabpanel"> 
                    <div class="col-md-12">
                        <ul class="nav nav-tabs" role="tablist">                           
                            ...
                            <li role="presentation"><a href="#total_part_shipped_to_sf" aria-controls="total_part_shipped_to_sf" class="spare_parts_tabs" role="tab" data-toggle="tab">Total Part Shipped To SF</a></li>
                            ...
                            <li role="presentation"><a href="#defective_part_pending" aria-controls="defective_part_pending" id="pending_defective_part" class="spare_parts_tabs" role="tab" data-toggle="tab">Defective Pending/Ok Part (All)</a></li>
                            <li role="presentation"><a href="#defective_part_pending_oot" aria-controls="defective_part_pending_oot" id="defective_part_oot" class="spare_parts_tabs" role="tab" data-toggle="tab">Defective Pending/Ok Part (OOT)</a></li>
                            ...
                            <li role="presentation"><a href="#courier_approved_defective_parts" aria-controls="courier_approved_defective_parts" class="spare_parts_tabs" role="tab" data-toggle="tab"> In Transit (Courier Approved Defective Parts)</a></li>
                            <li role="presentation"><a href="#defective_part_shipped_by_SF_approved" aria-controls="defective_part_shipped_by_SF" class="spare_parts_tabs" role="tab" data-toggle="tab">Defective/Ok To Be Received By Warehouse</a></li>
