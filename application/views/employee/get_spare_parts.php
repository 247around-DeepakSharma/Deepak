                ...
                <div role="tabpanel"> 
                    <div class="col-md-12">
                        <ul class="nav nav-tabs" role="tablist" >
                            <li role="presentation" class="active"><a href="#estimate_cost_requested" aria-controls="spare_parts_requested" role="tab" data-toggle="tab">Spare Quote Requested</a></li>
                            ...
                            <li role="presentation"><a href="#shipped" aria-controls="shipped" role="tab" data-toggle="tab">Partner Shipped Part(Approved)</a></li>
