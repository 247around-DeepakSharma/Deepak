                            ...
                            <div role="tabpanel"> 
                                <div class="col-md-12">
                                    <ul class="nav nav-tabs" role="tablist">                           
                                        ...
                                        <li role="presentation"><a href="#courier_lost_spare_parts" aria-controls="courier_lost_spare_parts" class="spare_parts_tabs" role="tab" data-toggle="tab"><!--Courier Lost Approval--> Courier Not Received Pending on Approval<span id="total_courier_lost"></span></a></li>
