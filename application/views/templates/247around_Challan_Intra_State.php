    ...
    <body>
        <table class="table"  style="border:solid 2px; border-collapse: collapse; width: 960px; height: 75%; font-family: sans-serif; font-size: 15px; margin: auto;">
            ...
            <tr style=""><td align="left" style="border-right: hidden;">
                ...
                <td colspan="2" style="text-align: right; border-left: hidden; border-right: 2px solid;"></td>
            </tr>
...
<!--            <tr style="text-align: center;" ><td colspan="10" style="padding-top: 0px;"><b>GSTIN: 09AAFCB1281J1ZM</td></tr>-->
            ...
            <tr><td colspan="3">Challan No:<?php echo $meta['invoice_id']; ?></td>		
            ...
            <tr><td width="32%"></td>
                <td rowspan="2" colspan="7" style="padding: 2%;background-color: rgb(211,211,211);"></td>
            </tr>
            <tr><td width="32%"></td></tr>
            <tr><td width="32%"></td>
