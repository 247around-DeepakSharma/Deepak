...
<body>
    <table id="table1">
        <tr>
            <td colspan="2" style="border-right: hidden;"><img style="padding: 2px;" src="<?php echo "https://s3.amazonaws.com/".BITBUCKET_DIRECTORY."/misc-images/".$excel_data['main_company_logo']; ?>"></td>
        ...
        <tr  style="text-align: center;">
            ...
            <td colspan="6" style="text-align: center"><b>Description</b></td>
            <td style="text-align: center"><b>Qty</b></td>
            <td colspan="3" style="text-align: center"><b>Booking ID</b></td>
            <td colspan="2" style="text-align: center"><b>Value (Rs.)</b></td>
        </tr>
        <?php
        $i = 1;
        $total_qty = 0;
        ...
        <tr  style="font-weight: bold;">
            <td colspan="6"></td>
            <td style="border-left: hidden; text-align: center"><b>Total Qty</b></td>
            <td style="text-align: center"><b><?php echo $total_qty; ?></b></td>
            <td colspan="3" style="text-align: center"><b>Total Amt</b></td>
            <td colspan="2" style="text-align: center"><b><?php echo $total_value; ?></b></td>
        </tr>
        <tr>
