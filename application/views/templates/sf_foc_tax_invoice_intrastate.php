...
<!--            <tr style="text-align: center;" ><td colspan="10"><b>GSTIN :  <?php //echo "$gst_number"; ?></td></tr>-->
            ...
            <tr style="height: 5%; "><td colspan="10" style="padding-top: 2%; padding-bottom: 2%; border-right: 2px solid">Address: A-34, FIRST FLOOR, SECTOR-63, NOIDA, UTTAR PRADESH, 201301</td></tr>
            <tr><td colspan="2">GSTIN: 09AAFCB1281J1ZM</td>
                <td colspan="6">Place of Supply: Uttar Pradesh</td>	
                <td colspan="2" style="border-right: 2px solid">Code: 09</td></tr>
