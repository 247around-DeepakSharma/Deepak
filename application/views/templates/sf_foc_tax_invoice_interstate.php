<html>
    ...
    <body>
        <table style="border:solid 2px; border-collapse: collapse; width: 960px; height: 75%; font-family: sans-serif; font-size: 15px; margin: auto;">
            <tr>
...
<!--            <tr style="text-align: center; font-weight: bold;"><td colspan="8">GSTIN :  <?php //echo "$gst_number"; ?></td></tr>-->
            ...
            <tr style="text-align: center;background-color: rgb(211,211,211);">
                ...
                <td rowspan="2" width="10%"><b>Total</td>
            </tr>
            ...
            ?>
                <tr style='text-align: center;'>
                        ...
                        <td width="10%"><?php echo $data['total_amount']; ?></td>
                </tr>
            <?php
            }
            ?>		
            ...
            <tr>
                <td colspan="4" height="30%" style="padding: 3%">&nbsp</td>
            </tr>
