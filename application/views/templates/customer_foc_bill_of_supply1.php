    ...
    <body>
        <table class="table">
           ...
           <tr style="text-align: center; height: 50px; font-size: 40px;background-color: rgb(211,211,211);">	
            ...
            <tr style="height: 5%"><td colspan="6" style="padding-top: 2%; padding-bottom: 2%; border-right: 2px solid;">Address: A-34, FIRST FLOOR, SECTOR-63, NOIDA, UTTAR PRADESH, 201301</td></tr>
            <tr><td colspan="2">GSTIN: 09AAFCB1281J1ZM</td>
                <td colspan="3" width="30%">Place of Supply: Uttar Pradesh</td>	
                <td style="border-right: 2px solid;">Code: 09</td></tr>
