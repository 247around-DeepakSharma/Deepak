<html>
    <head>
        <title>247 Around Challan</title>
        <style type="text/css">
            .table{
                border:solid 1px;
    ...
    <body>
        <table  style="border:solid 1px; border-collapse: collapse; width: 960px;height: 75%;font-family: sans-serif;margin: auto;">
            ...
            <tr style="">
                ...
                <td colspan="2" style="text-align: right;  border-left: hidden;"></td>
            </tr>
<!--            <tr style="text-align: center; height: 50px; font-size: 40px;background-color: rgb(211,211,211);">
            ...
            <tr>
                <td colspan="3">Challan No:<?php echo $meta['invoice_id'];?></td>
                <td colspan="5"></td>
            </tr>
    
            <tr>
                <td colspan="3">Date: <?php echo date("d-M-Y", strtotime($meta['invoice_date']));?></td>
                <td colspan="5"></td>
            <tr>
            ...
            <tr>
                <td align="center" style="background-color: rgb(211,211,211); width:30px;"></td>
