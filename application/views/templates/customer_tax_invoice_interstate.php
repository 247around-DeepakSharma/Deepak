    ...
    <body>
        <table style=" border:solid 2px; border-collapse: collapse; width: 960px; height: 75%; font-family: sans-serif; font-size: 100%; margin: auto;">
            ...
            <tr style="">
                ...
                <td colspan="3" style="text-align: center; border-left: hidden;"><b>(<?php echo "$recipient_type"; ?>)</td>
            </tr>
...
<!--            <tr style="text-align: center;" ><td colspan="8">GSTIN :  <?php echo "$gst_number"; ?></td></tr>-->
            ...
            <tr><td colspan="3">Invoice Date: <?php echo date("d-M-Y", strtotime($meta['invoice_date'])); ?></td>	
            ...
            <tr width="100%" style="text-align: center; background-color: rgb(211,211,211);">
                <td rowspan="2" width="40%"><b>Product Description</td>
                <td rowspan="2" width="10%"><b>HSN/SAC <br>Code</td>
                <td rowspan="2" width="5%"><b>Qty</td>
                <td rowspan="2" width="5%"><b>Rate</td>
                <td rowspan="2" width="8%"><b>Taxable value</td>
                <td colspan="2" width="17%"><b>IGST</td>
                <td rowspan="2" width="15%"><b>Total</td>
            </tr>
            <tr align="center" style="background-color: rgb(211,211,211)">
                <td style="font-size:80%"><b>Rate</td>
                <td style="font-size:80%"><b>Amount</td>
            </tr>
            ...
            ?>
                <tr style='text-align: center;'>
                    ...
                    <td width="15%"><?php echo $data['total_amount']; ?></td>
                </tr>
            <?php
            }
            ?>		
