...
<!--            <tr style="text-align: center; height: 50px; font-size: 40px;background-color: rgb(211,211,211);">
             ...
             <tr style="text-align: center; height: 50px; font-size: 40px;background-color: rgb(211,211,211);">	
                 <td colspan="8"  align="center"><b><?php echo "Bill Of Supply"; ?></b>
             </tr>
            <tr>
            ...
            <tr style="text-align: center; background-color: rgb(211,211,211);">
                ...
                <td rowspan="2" colspan="3" style="font-size: 13px;"><b>Total</td>
            </tr>
            ...
            <tr style='text-align: center;'>
                ...
                <td width="20%" colspan="3" ><?php echo $data['total_amount']; ?></td>
            </tr>
            ...
            <tr align="left" >
                ...
                <td width="30%" colspan="1"><b>Total Amt</td>
                <td width="10%" colspan="3"><?php echo $meta['sub_total_amount']; ?></td>
            </tr>
            <tr align="left">
