<html>
    ...
    <body>
        <table class="table" style="border:solid 2px; border-collapse: collapse; width: 960px; height: 75%; font-family: sans-serif;font-size: 100%; margin: auto;">
            ...
            <tr>
                <td align="left" style="border-right: hidden;"><img style="padding: 5px;" src="https://aroundhomzapp.com/images/logo.jpg"></td>
...
<!--            <tr style="text-align: center;" ><td colspan="10">GSTIN :  <?php// echo "$gst_number"; ?></td></tr>-->
            ...
            <tr style="height: 20px"><td colspan="10">Name: 247around service center - <?php echo $meta['customer_name']; ?></td></tr>
