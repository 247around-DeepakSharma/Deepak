...
define("BOOKING_COUNT_MISMATCH_MESSAGE", "<span style='color:red;'>*This total number of bookings may slightly vary from main dashboard due to SF not assigned bookings are not shown here</span>");
