...
/*  If Shipped is empty or NULL Show Requested Data */
        $sp_details = $this->partner_model->get_spare_parts_by_any("spare_parts_details.part_warranty_status,IFNULL(spare_parts_details.parts_shipped,spare_parts_details.parts_requested),IF(spare_parts_details.shipped_parts_type=' ',spare_parts_details.parts_requested_type,spare_parts_details.shipped_parts_type),spare_parts_details.status,spare_parts_details.shipped_parts_type", array('booking_id' => $booking_id));
