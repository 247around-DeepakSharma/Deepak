<?php
include("booking_job_card_variables.php");
?>
<html>
  <head>
  ...
  <tr><td colspan="6" style="text-align: right; border-bottom: hidden;padding: 2%"><b><?php echo "$qr_message"?></td></tr>
  ...
  <td colspan="5"><p><?php echo "$booking_address"?>,<br>

                      <?php echo "$city"?>,<?php echo "$state"?>,<?php echo "$booking_pincode"?></p></td>
  </tr>
  ...
  <td height=50px><p><b>Signature</b></p></td>
