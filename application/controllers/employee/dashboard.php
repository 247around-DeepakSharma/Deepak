...
class Dashboard extends CI_Controller {
    ...
    function index() {
        ...
        //get partner booking entered and scheduled data
        $partners_inflow_data = $this->partners_booking_inflow(false, $startDate, $endDate);
        $data_report['inflow_partner_name'] = $partners_inflow_data['partner_name'];
        $data_report['inflow_booking_entered'] = $partners_inflow_data['followup'];
        $data_report['inflow_booking_pending'] = $partners_inflow_data['pending'];
        // get foc and paid booking data
