...
<?php
    ...
    function getCovidZoneName($city){
        ...
        $districtZoneType = ' <br/><span style="background-color:#d9534f;">COVID</span>';
        }
        if (strpos($districtZoneType, 'Orange') !== false) {
        $districtZoneType = '<br/> <span  style="background-color:#f0ad4e;" >COVID</span>';
        }
        if (strpos($districtZoneType, 'Green') !== false) {
        $districtZoneType = '<br/> <span style="background-color:#5cb85c;" >COVID</span>';
        }
