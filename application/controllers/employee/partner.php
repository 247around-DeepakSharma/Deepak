...
//            {
    ...
    */
    ...
    function get_nrn_approval(){
      ...
      //   }
       $partner_id = $this->session->userdata('partner_id');
       $where = "spare_parts_details.partner_id = '" . $partner_id . "' AND  spare_parts_details.entity_type =  '"._247AROUND_PARTNER_STRING."' AND status IN('".NRN_APPROVED_BY_ADMIN."', '".NRN_APPROVED_BY_PARTNER."') " 
                . " AND booking_details.current_status IN ('"._247AROUND_PENDING."', '"._247AROUND_RESCHEDULED."') "
                . " ";
       if($this->input->post('state')){
           $state = $this->input->post('state');
