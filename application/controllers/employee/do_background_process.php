...
class Do_background_process extends CI_Controller {
	...
	if ($err_count === 0) {
     ...
     function complete_booking(){
        ...
        log_message('info', "Entering: " . __METHOD__." Booking Id ". print_r($booking_id));
        foreach ($booking_id as $key => $value) {
            ...
            unset($data[0]['id']); unset($data[0]['service_center_id']); 
            $data[0]['closing_remarks'] = "Service Center Remarks:- ".$data[0]['service_center_remarks']. " <br/> Admin:-  ".  $data[0]['admin_remarks'];
          
            unset($data[0]['admin_remarks']); unset($data[0]['create_date']); 
            ...
            $this->booking_model->rate( $data[0]['booking_id'], $data[0]);
        ...
        $message = "Booking Completion.<br>Customer name: " . $query1[0]['name'] . "<br>Customer phone number: " . $query1[0]['phone_number'] . "<br>Customer email: " . $query1[0]['user_email'] . "<br>Booking Id is: " . $query1[0]['booking_id'] . "<br>Your service name is:" . $query1[0]['services'] . "<br>Booking date: " . $query1[0]['booking_date'] . "<br>Booking completion date: " . $data[0]['closed_date'] . "<br>Amount paid for the booking: " . $data[0]['amount_paid'] . "<br>Your booking completion remark is: " . $data[0]['closing_remarks'] . "<br> Thanks!!";
