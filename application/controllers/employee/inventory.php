    ...
    * @desc This function is used to get success message when spare cancelled but this is not on priority.
    ...
    function  download_sale_purchage_invoice_data(){
        ...
        $select = "invoice_details.invoice_id AS 'Invoice Id', invoice_details.create_date AS 'Invoice Date', case when (type_code = 'B') THEN 'Purchase Invoice' ELSE 'Sale Invoice' END AS 'Invoice Type', part_number AS 'Part Number', "
                ...
                . "vendor_partner_invoices.sub_category AS 'Sub Category',courier_details.AWB_no AS 'Awb_Number',courier_details.courier_name AS 'Courier Name',courier_details.shipment_date AS 'Shipment Date',courier_details.quantity AS 'Quantity',courier_details.booking_id AS 'Booking Id'";
