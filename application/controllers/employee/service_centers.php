...
//        }
    ...
    function update_spare_parts_details() {
        ...
        if (!empty($change_inventory_id)) {
            ...
            $warehouse_details = $this->miscelleneous->check_inventory_stock($data['requested_inventory_id'], $partner_id, $sf_state[0]['state'], $service_center_id);
...
//        $code_source = $booking_sources[0]['code'];
    ...
    function get_defective_parts_shipped_by_sf($page = 0, $offset = 0) {
        ...
        $select = "defective_part_shipped, spare_parts_details.defective_part_rejected_by_partner,spare_parts_details.id, "
