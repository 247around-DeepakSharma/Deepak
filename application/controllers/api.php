...
class Api extends CI_Controller {
    ...
    public function index() {
        ...
        //$str = '{"request":"{\"requestId\":\"249c0d03-5123-487a-9ad9-cbe487ed95bc\",\"requestUrl\":\"tommorowBookings\",\"deviceId\":\"MzU4MjQwMDUxMTExMTEwLWU0YmNiNTcwM2MyZjczMGUtMDI6MDA6MDA6MDA6MDA6MDAtbnVsbA\\u003d\\u003d\",\"token\":\"eyJhbGciOiJzaGEyNTYiLCJ0eXAiOiJKV1QifQ\\u003d\\u003d.\\u003d.NWM2ZjY0NDEyODRmY2ZkNzQ5ZTk1NWVlOGEzOWYzYTJmZTA5MmI2MTk3YzNkZTJjYzJiNWMzZDUwM2JjNWYyNA\\u003d\\u003d\"}"}';
 ...
 */
    ...
    function getMissedBookingList($select, $service_center_id, $engineer_id){
            ...
            $missed_bookings = $this->booking_model->get_booking_details($select, $missed_where, true, true, true);
    ...
    function getTommorowBookingList($select, $service_center_id, $engineer_id){
        ...
        $tommorow_bookings = $this->booking_model->get_booking_details($select, $where, true, true, true);
    ...
    function getMissedBookings(){
        ...
        if (!empty($requestData["engineer_id"]) && !empty($requestData["service_center_id"])) {
            ...
            $response = $this->getMissedBookingList($select, $requestData["service_center_id"], $requestData["engineer_id"]);
    ...
    function getTommorowBookings(){
        ...
        if (!empty($requestData["engineer_id"]) && !empty($requestData["service_center_id"])) {
            $select = "booking_details.booking_id, users.name, booking_details.booking_address, booking_details.state, booking_unit_details.appliance_brand, services.services, booking_details.request_type";
            $response = $this->getTommorowBookingList($select, $requestData["service_center_id"], $requestData["engineer_id"]);
