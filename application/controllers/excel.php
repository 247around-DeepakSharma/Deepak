...
class Excel extends CI_Controller {
  ...
  /**
   *  @desc : This function load excel view and call filter
   *  @param : void
   *  @return : void
   */
 ...
 */
    ...
    function duplicateviewload($handymanDetail){
          ...
          $this->load->view('admin/header',$result);
          $this->load->view('admin/duplicateExcel',$handyman);
 ...
 */
  ...
  /**
   * @desc : This getimage from s3 buckket and resize to uploads3 buckket
   * @param : id of get image 
   * @return : true
   */
  ...
  /**
   *  @desc : This function for download all handyman data in csv file
   *  @param : void
   *  @return : void
   */
    ...
    function download_handyman(){
      $this->load->dbutil();
      $backup = $this->handyman_model->download_handyman();
      $this->load->helper('download');
      force_download('handyman.csv', $backup);
    }
