...
class Bb_model extends CI_Model {
    ...
    var $cp_action_column_search = array('bb_order_details.partner_order_id', 'name', 'category', 'brand', 'physical_condition', 'working_condition', 'internal_status');
    var $cp_action_column_order = array('bb_order_details.partner_order_id', 'name', 'category', 'brand', 'physical_condition', 'working_condition', 'internal_status');
