...
class Cp_model extends CI_Model {
   ...
   var $column_order = array(NULL,'name', 'contact_person',NULL,NULL, 'shop_address_line1',NULL,'shop_address_region'); //set column field database for datatable orderable
    ...
    var $bb_select = 'bb_unit_details.partner_order_id,bb_order_details.partner_id, services,city, order_date, bb_cp_order_action.internal_status, delivery_date, bb_cp_order_action.current_status, '
            ...
            . 'bb_unit_details.category,bb_order_details.partner_tracking_id,bb_unit_details.cp_claimed_price,bb_order_details.acknowledge_date,bb_order_details.auto_acknowledge_date,bb_order_details.auto_acknowledge';
    ...
    function _get_cp_shop_address_list_query($post) {
        $this->db->select('bb_shop_address.id, name, contact_person, '
                ...
                . ' bb_shop_address.contact_email, tin_number, alternate_conatct_number2, shop_address_state,cp_capacity,bb_shop_address.cp_id');
