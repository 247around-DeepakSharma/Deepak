...
//            @Note : Do not change anything in select Statement, It may have Impact on Multiple Pages           
     ...
     */
    function get_booking_for_review($booking_id,$status,$whereIN,$is_partner,$offset = NULL, $perPage = NULL,$having_arr=array(),$where_arr=array(),$join_arr=array(),$orderBY=NULL) {
        $charges = $this->service_centers_model->getcharges_filled_by_service_center($booking_id,$status,$whereIN,$is_partner,$offset,$perPage,$having_arr,$where_arr,$join_arr,$orderBY);
