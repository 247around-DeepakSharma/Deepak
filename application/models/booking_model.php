...
class Booking_model extends CI_Model {
    ...
    function getbooking_history($booking_id, $join=""){
        ...
        $query1 = $this->partner_model->get_spare_parts_by_any('spare_parts_details.*,inventory_master_list.part_number,inventory_master_list.part_name as final_spare_parts,im.part_number as shipped_part_number,original_im.part_name as original_parts,original_im.part_number as original_parts_number', array('booking_id' => $booking_id),false,false,false,$post);//, symptom_spare_request.spare_request_symptom
        if(!empty($query1)){
            $result1 = $query1;
