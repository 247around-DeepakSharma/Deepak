...
//        $this->db->join('service_center_booking_action', 'booking_details.booking_id  = service_center_booking_action.booking_id', 'left');
     ...
     *  @return: Array()
     */
        function get_bookings_by_status($post, $select = "",$sfIDArray = array(),$is_download=0,$is_spare=NULL,$partner_details=0,$join_array=array(),$join_type_array=array()) {        $this->_get_bookings_by_status($post, $select);
        if ($post['length'] != -1) {
