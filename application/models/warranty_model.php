...
class Warranty_model extends CI_Model {
    ...
    function check_warranty_by_booking_ids($arrBookings) {
        ...
        $strSelect = "booking_details.booking_id,booking_details.service_id,booking_details.partner_id,"
                ...
                . "ifnull(spare_parts_details.date_of_purchase, ifnull(booking_unit_details.sf_purchase_date,ifnull(service_center_booking_action.sf_purchase_date, booking_unit_details.purchase_date))) as date_of_purchase,"
        ...
        $this->db->join('warranty_plans', 'warranty_plan_model_mapping.plan_id = warranty_plans.plan_id and date(warranty_plans.period_start) <= ifnull(spare_parts_details.date_of_purchase, ifnull(booking_unit_details.sf_purchase_date,ifnull(service_center_booking_action.sf_purchase_date, booking_unit_details.purchase_date))) and date(warranty_plans.period_end) >= ifnull(spare_parts_details.date_of_purchase, ifnull(booking_unit_details.sf_purchase_date,ifnull(service_center_booking_action.sf_purchase_date, booking_unit_details.purchase_date))) and warranty_plans.is_active = 1 and warranty_plans.partner_id = booking_details.partner_id', 'Left');
