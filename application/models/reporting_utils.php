...
//            $result1 = $query1->result_array();
    ...
    function get_uploaded_file_history($post_data=NULL)
    {
        ...
        $sql = "SELECT IF(e.full_name IS NULL,entity_login_table.agent_name,e.full_name) as agent_name,p.file_name,p.create_date AS upload_date,p.result, p.id, p.revert_file_name, p.amount_paid FROM file_uploads AS p  left JOIN employee AS e ON p.agent_id = e.id LEFT JOIN entity_login_table ON p.agent_id = entity_login_table.agent_id ";
