...
//            $this->db->where($stateWhere, false);  
    ...
    function getcharges_filled_by_service_center($booking_id,$status,$whereIN,$is_partner,$offest,$perPage,$having_arr=array(),$where_arr=array(),$join_arr=array(),$orderBY = NULL) {
