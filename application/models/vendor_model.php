   ...
   /**
    ...
    function add_vendor_login($login) {
     ...
     function sf_insert_miscellaneous($vendor_data_miscellaneous) {
        $this->db->insert('sf_miscellaneous_details', $vendor_data_miscellaneous);
     }

      function sf_update_miscellaneous($where, $data_miscelleneous){
        $this->db->where($where);
        return $this->db->update("sf_miscellaneous_details", $data_miscelleneous);
    }

    function fetch_sf_miscellaneous_data($select,$where) {
        $this->db->select($select);
        $this->db->where($where);
        $query = $this->db->get('sf_miscellaneous_details');
        return $query->result_array();
    }
