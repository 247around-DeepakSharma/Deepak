...
class Trackingmore_api {
     ...
     * @return array
     */
   public function getTrackingsList($numbers = "", $orders = "", $page = 1, $limit = 200, $createdAtMin = 0, $createdAtMax = 0, $update_time_min = 0, $update_time_max = 0, $order_created_time_min = 0, $order_created_time_max = 0, $lang = "en") {
        $returnData = array();
        $sendData = array();
