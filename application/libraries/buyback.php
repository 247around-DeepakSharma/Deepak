...
class Buyback {
    ...
    function update_bb_order($order_data) {
        ...
        if ($order_data[0]['is_delivered'] == 0) {
                ...
                if(in_array($order_data[0]['current_status'],[_247AROUND_BB_TO_BE_CLAIMED, _247AROUND_BB_ORDER_NOT_RECEIVED_INTERNAL_STATUS, CLAIM_DEBIT_NOTE_RAISED, CLAIM_SUBMITTED, CLAIM_APPROVED, CLAIM_REJECTED, CLAIM_SETTLED, _247AROUND_BB_CANCELLED, _247AROUND_BB_ORDER_REJECTED]) && $this->POST_DATA['current_status'] != _247AROUND_BB_DELIVERED) {
                    return false;    
                }
