    ...
    function send_sms_msg91($sms) {
        ...
        if (!empty($template)) {
            ...
            if ($smsBody) {
                ...
                if ( (isset($status['content']) && !empty($status['content'])) || (isset($status['content']) && !empty($status['content']))  && (ctype_alnum($status['content']) && strlen($status['content']) == 24) || (ctype_alnum($status['content']) && strlen($status['content']) == 25) 
