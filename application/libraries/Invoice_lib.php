...
//                 array_push($int_invoice, $explode[1] + 1);
 ...
 /**
    ...
    function generate_challan_file_to_partner($spare_id, $service_center_id, $service_center_closed_date = "") {
        ...
        $where = array('spare_parts_details.id' => $spare_id,'spare_parts_details.entity_type' => _247AROUND_PARTNER_STRING, "status" => DEFECTIVE_PARTS_SHIPPED, 'defective_part_required' => 1);
