...
<!-- 17 Aug -->
ALTER TABLE  `booking_unit_details` CHANGE  `tax_rate`  `tax_rate` DECIMAL( 10, 3 ) NOT NULL ;
...
ALTER TABLE  `service_centre_charges` ADD  `pod_required` VARCHAR( 10 ) NOT NULL DEFAULT  '0' AFTER  `check_box` ;
