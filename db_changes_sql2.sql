...
UPDATE `email_template` SET `template` = 'Spare not transferred due to no available of stock ,Booking ID is %s, <br/>Inventory ID is %s <br>,Part Number is %s .\r\n', `to` = 'abhisheka@247around.com', `bcc` = 'abhisheka@247around.com' WHERE `email_template`.`id` = 159;