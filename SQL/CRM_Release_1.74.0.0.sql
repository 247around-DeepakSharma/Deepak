...
CREATE TABLE `whatsapp_template` (
 ...
 `attachment` varchar(15) DEFAULT NULL,
 `category` varchar(32) DEFAULT NULL,
 `comments` varchar(1024) DEFAULT NULL,
 `active` varchar(10) NOT NULL,
 `terminal_msg` tinyint(1) NOT NULL DEFAULT '0',
...
ALTER TABLE `whatsapp_logs` ADD `booking_id` VARCHAR(20) NULL DEFAULT NULL AFTER `id`;
ALTER TABLE `whatsapp_logs` ADD `muid` VARCHAR(64) NULL DEFAULT NULL AFTER `booking_id`;
ALTER TABLE `whatsapp_template` ADD `options_id` INT(11) NULL DEFAULT NULL AFTER `is_exception_for_length`;

CREATE TABLE `whatsapp_options` (
 `id` int(11) NOT NULL AUTO_INCREMENT,
 `msg_tag_id` int(11) NOT NULL,
 `option_text` text NOT NULL,
 `action_id` int(11) NOT NULL,
 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8

CREATE TABLE `boloaaka`.`whatsapp_option_action` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `option_id` INT(11) NOT NULL ,  `tag_id` INT(11) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;
ALTER TABLE `whatsapp_options` ADD `data_set` TEXT NULL DEFAULT NULL AFTER `action_id`;
ALTER TABLE `whatsapp_logs` ADD `message_tag` VARCHAR(64) NULL DEFAULT NULL AFTER `muid`;
